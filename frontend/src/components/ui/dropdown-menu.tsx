...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[180px] overflow-hidden rounded-xl border border-border bg-card p-1 shadow-lg",
...
export {
  ...
  DropdownMenuRadioGroup, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator,
};
